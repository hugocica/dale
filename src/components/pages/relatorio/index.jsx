                        ...
                        <Book.Page>
                            <Book.Side>
                                <div className="book-page right">
                                    ...
                                    <p>
                                    Para entender melhor a história do Arduino e do que exatamente ele se trata, aqui vai a sugestão de um documentário sobre o surgimento dele na Itália e quais eram os ideais de seus criadores na época.
                                    </p>
...
Seu formato é basicamente o de um Pad de botões utilizado para finger drumming, – atividade semelhante à de tocar um instrumento, porém com samples (uma amostra de som de um instrumento ou qualquer outra música já composta anteriormente) pré-definidos – possuindo também 8 Knobs (potenciômetro giratório) e 5 sliders (potenciômetro deslizante) que podem ter suas funções definidas à escolha do usuário.
                                    </p>
