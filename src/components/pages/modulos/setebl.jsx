...
import ImgTecnica from '../../../assets/img/modulos/7bl_tecnico.svg'

class Modulo7bl extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <div className="content-wrapper inner-modulo-page setebl-page">
                <Menu />

                <div className="main-container">

                    <div className="modulo-banner red-bg">
                        <div className="container">
                            <div className="col-md-12">
                                <img src="https://res.cloudinary.com/hugo-cicarelli/image/upload/v1542587307/7bl_banner_cinza.png" alt="7bl logo"/>
                            </div>

                            <img className="modulo-modelo" src="https://res.cloudinary.com/hugo-cicarelli/image/upload/v1543251626/jog.png" alt="7bl modelo"/>
                        </div>
